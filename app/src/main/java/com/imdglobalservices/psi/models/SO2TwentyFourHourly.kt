 ...
 * @since 2017.15.11
 */
class SO2TwentyFourHourly : Parcelable {
    @SerializedName("east")
    @Expose
    ...
    companion object {
        ...
        val CREATOR: Parcelable.Creator<COSubIndex> = object : Parcelable.Creator<COSubIndex> {
            override fun createFromParcel(source: Parcel): COSubIndex {
                return COSubIndex(source)
            }

            override fun newArray(size: Int): Array<COSubIndex?> {
