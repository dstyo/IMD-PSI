...
class PM10SubIndex : Parcelable {
    ...
    companion object {
        ...
        val CREATOR: Parcelable.Creator<PM10SubIndex> = object : Parcelable.Creator<PM10SubIndex> {
            override fun createFromParcel(source: Parcel): PM10SubIndex {
                return PM10SubIndex(source)
            }

            override fun newArray(size: Int): Array<PM10SubIndex?> {
